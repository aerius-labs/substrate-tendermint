...
use finality_tendermint::{messages, BlockNumberOps, VoterSet};
...
impl<Block: BlockT> TendermintJustification<Block> {
        ...
        NumberFor<Block>: BlockNumberOps,
    {
        ...
        if (
            justification.f_commit.target_hash,
            justification.f_commit.target_number,
        ) != finalized_target
        {
    ...
    where
        NumberFor<Block>: BlockNumberOps,
    {
        let voters = VoterSet::new(authorities.to_vec()).ok_or(ClientError::Consensus(
